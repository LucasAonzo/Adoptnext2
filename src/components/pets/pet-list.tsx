  ...
  return (
    <div className="w-full">
        ...
        <div className="mb-6">
          <h2 
            ...
            style={{ 
              ...
              lineHeight: ui.typography.lineHeight.tight,
            }}
          >
            {title}
          </h2>
          <div 
            className="mt-2 h-1 w-24 rounded-full bg-[color:var(--primary)]"
            style={{ borderRadius: ui.radius.full }}
          />
        </div>
      )}
      ...
      {!isLoading && pets.length === 0 && (
        <div 
          className="bg-white rounded-xl p-8 border border-[color:var(--border)] text-center animate-fade-in"
          style={{ 
            borderRadius: ui.radius.xl,
            boxShadow: ui.shadows.sm,
            padding: ui.spacing[8],
          }}
        >
          <div className="flex flex-col items-center justify-center py-10">
            <svg 
              ...
              className="text-[color:var(--primary-light)] mb-4"
            >
            ...
            <h3 
              className="text-xl font-bold mb-2 text-[color:var(--foreground)]"
              style={{ 
